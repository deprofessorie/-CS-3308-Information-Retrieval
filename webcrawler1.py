#!/usr/bin/env python3
'''
    webcrawler1.py -- Example webcrawler or 'spider' code
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    This script implements the requirements of Unit 7 Programming
    Assignment within CS-3308 - Information Retrieval course at
    UoPeople (AY2023-T3).

    Usage:  python3 webcrawler1.py
...
stopwords = [
    ...
    'are', 'any', 'she', 'if', 'said', 'so', 'which', 'have', 'do',
    'we', 'no', 'my', 'were', 'them', 'their', 'him', 'one', 'will',
    'me', 'there', 'who', 'up', 'other', 'an', 'its', 'when', 'what',
    'can', 'may', 'into', 'out', 'must', 'your', 'then', 'would',
    'could', 'more', 'now', 'has', 'like', 'down', 'where', 'been',
    'through', 'did', 'away', 'these', 'such', 'set', 'back', 'some',
    'than', 'way', 'made', 'our', 'after', 'well', 'should', 'get',
    'even', 'am', 'go', 'saw', 'just', 'put', 'while', 'ever', 'off',
    'here', 'also',
    ]

# regular expression for: extract words
...
if __name__ == '__main__':
    ...
    #
    con = sqlite3.connect("webcrawler1.db")
    ...
    while numberOfCrawls < maxNumberOfCrawls:
        #
